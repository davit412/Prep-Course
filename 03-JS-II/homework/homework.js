...
function fizzBuzz(numero) {
  ...
  if( divisibleCinco ===0 && divisibleTres === 0 ) return "fizzbuzz";

  if( divisibleCinco === 0) return "buzz";
  
  if(divisibleTres === 0)  return "fizz";
  return numero;
}
